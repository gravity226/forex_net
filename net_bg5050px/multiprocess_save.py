...
def check_prime(n): # n = lower range
    ...
    ax.fill_between(range(5), [df.ix[r[0]: r[1]].high.max()] * 5, [df.ix[r[0]: r[1]].low.min()] * 5, color=c)
    ...
    # ax.fill_between(range(5), df.ix[r[0]: r[1]].close.values.tolist(), df.ix[r[0]: r[1]].open.values.tolist(), color='y')
    ax.plot(range(ticks), df.ix[r[0]: r[1]].close.values.tolist(), lw=1, color='y', alpha=1)
    # ax.plot(range(ticks), df.ix[r[0]: r[1]].open.values.tolist(), lw=1, color='y', alpha=1)
