...
def check_prime(n): # n = lower range
    ...
    ax.plot(range(ticks), df.ix[r[0]: r[1]].close.values.tolist(), lw=2, color='b', alpha=1)
    # ax.plot(range(ticks), df.ix[r[0]: r[1]].open.values.tolist(), lw=1, color='g', alpha=.5)
    # ax.plot(range(ticks), df.ix[r[0]: r[1]].high.values.tolist(), lw=1, color='r', alpha=.5)
    # ax.plot(range(ticks), df.ix[r[0]: r[1]].low.values.tolist(), lw=1, color='k', alpha=.5)
